			...
			<div class="board_wrap">
				...
				<div class="board_view_info">
					<form action="${contextPath }/member/genmodify" method="post">
						<p><input type="text" readonly name="id" value="${geninfo.dto.id}"><br></p>
						<p><input type="text" name="pwd" placeholder="pwd"><br></p>
						<p><input type="text" name="name" placeholder="이름" value="${geninfo.dto.name}"><br></p>
						<p><input type="text" name="birth" placeholder="생년월일" value="${geninfo.dto.birth}"><br></p>
						<p><input type="text" name="email" placeholder="email" value="${geninfo.dto.email}"><br></p>
						...
						<p><input type="text" name="tel" placeholder="tel" value="${geninfo.dto.tel}"><br></p>
