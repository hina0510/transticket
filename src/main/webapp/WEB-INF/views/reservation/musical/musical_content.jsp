		        ...
		        <div class="board_view_wrap">
		            <div class="board_view">
			        		...
			        		<section class="board_view_title_sec">
				                ...
				                <div class="info">
				                	...
				                	<div class="info_div02">
					                    ...
					                    <dl>
					                        <dt>일시</dt>
					                        <dd>${dto.mu_stDate} ~ ${dto.mu_endDate}</dd>
					                    </dl>
					                    <dl>
					                        <dt>가격</dt>
					                        <dd>${dto.price}</dd>
		                ...
		                <div class="board_view_info">
							...
							<div id="tab-2" class="tab-content3"><%@ include file="musical_info02.jsp" %></div>
							<div id="tab-3" class="tab-content3"><%@ include file="musical_info03.jsp" %></div>
		                </div>
					</div>
		            <div class="frame">
