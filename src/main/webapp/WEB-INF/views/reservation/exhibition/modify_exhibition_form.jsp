				...
				<form action="write_concert_Save">
					<table>
						<tr>
							...
							<td><textarea cols="80" rows="1" name="title">${edto.title }</textarea></td>
						</tr>
						...
						<tr>
							...
							<td>
								<input type="date" name="startDate" value="${edto.ex_stDate}">
								<div id="betweenDate">~</div>
           						<input type="date" name="endDate" value="${edto.ex_endDate}">
							</td>
						</tr>
						<tr style="height: 10px;">
						</tr>
