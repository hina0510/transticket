				...
				<form action="write_concert_Save"  method="post" enctype="multipart/form-data">
					<table>
						<tr>
							...
							<td><textarea cols="80" rows="1" name="title"></textarea>${cdto.title }</td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" name="comname" readonly value="${cdto.comname}"></td>
						</tr>
						<tr style="height: 10px;">
						</tr>
						<tr>
							...
							<td>
								<input type="date" name="startDate" value="${cdto.con_stDate}">
								<div id="betweenDate">~</div>
           						<input type="date" name="endDate" value="${cdto.con_endDate}">
							</td>
						</tr>
						<tr style="height: 10px;">
						</tr>
						...
						<tr>
							<td colspan="2"><textarea rows="25" cols="80" name="content" id="content">${cdto.content}</textarea></td>
						</tr>
						<tr style="height: 10px;">
						</tr>
						<tr>
							<td colspan="2">
								<table style="margin: auto">
									<tr>
										<td>
											<c:choose>
						                		<c:when test="${cdto.imageName1 != 'nan' }">
						                			<input type="file" id="img1" name="imageName1"  style="display: none;" accept="image/*" onchange="imgChg(this, 'img1Pre', 'image1')">
									    			<label for="img1">
						                				<img src="imgView?name=${cdto.imageName1 }" id="img1Pre" onclick="" width="100" height="100" alt="없음">
						                				<input type="hidden" name="image1" id="image1" value="${cdto.imageName1 }">
						                			</label>
						                		</c:when>
						                		<c:otherwise>
						                			<input type="file" id="img1" name="imageName1"  style="display: none;" accept="image/*" onchange="imgChg(this, 'img1Pre', 'image1')">
										...
										<td>
											<c:choose>
						                		<c:when test="${cdto.imageName2 != 'nan' }">
						                			<input type="file" id="img2" name="imageName2"  style="display: none;" accept="image/*" onchange="imgChg(this, 'img2Pre', 'image2')">
									    			<label for="img2">
						                				<img src="imgView?name=${cdto.imageName2 }" id="img2Pre" onclick="" width="100" height="100" alt="없음">
						                				<input type="hidden" name="image2" id="image2" value="${cdto.imageName2 }">
						                			</label>
						                		</c:when>
						                		<c:otherwise>
						                			<input type="file" id="img2" name="imageName2"  style="display: none;" accept="image/*" onchange="imgChg(this, 'img2Pre', 'image2')">
										...
										<td>
											<c:choose>
							               		<c:when test="${cdto.imageName3 != 'nan' }">
							               			<input type="file" id="img3" name="imageName3"  style="display: none;" accept="image/*" onchange="imgChg(this, 'img3Pre', 'image3')">
									    			<label for="img3">
							               				<img src="imgView?name=${cdto.imageName3 }" id="img3Pre" onclick="" width="100" height="100" alt="없음">
							               				<input type="hidden" name="image3" id="image3" value="${cdto.imageName3 }">
							               			</label>
							               		</c:when>
							               		<c:otherwise>
							               			<input type="file" id="img3" name="imageName3"  style="display: none;" accept="image/*" onchange="imgChg(this, 'img3Pre', 'image3')">
										...
										<td>
											<c:choose>
							               		<c:when test="${cdto.imageName4 != 'nan' }">
							               			<input type="file" id="img4" name="imageName4"  style="display: none;" accept="image/*" onchange="imgChg(this, 'img4Pre', 'image4')">
									    			<label for="img4">
							               				<img src="imgView?name=${cdto.imageName4 }" id="img4Pre" onclick="" width="100" height="100" alt="없음">
							               				<input type="hidden" name="image4" id="image4" value="${cdto.imageName4 }">
							               			</label>
							               		</c:when>
							               		<c:otherwise>
							               			<input type="file" id="img4" name="imageName4"  style="display: none;" accept="image/*" onchange="imgChg(this, 'img4Pre', 'image4')">
										...
										<td>
											<c:choose>
							               		<c:when test="${cdto.imageName5 != 'nan' }">
							               			<input type="file" id="img5" name="imageName5"  style="display: none;" accept="image/*" onchange="imgChg(this, 'img5Pre', 'image5')">
									    			<label for="img5">
							               				<img src="imgView?name=${cdto.imageName5 }" id="img5Pre" onclick="" width="100" height="100" alt="없음">
							               				<input type="hidden" name="image5" id="image5" value="${cdto.imageName5 }">
							               			</label>
							               		</c:when>
							               		<c:otherwise>
							               			<input type="file" id="img5" name="imageName5"  style="display: none;" accept="image/*" onchange="imgChg(this, 'img5Pre', 'image5')">
